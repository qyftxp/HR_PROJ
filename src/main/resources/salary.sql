...
create table salary_grant( 
	...
	insert into  salary_grant(salary_grant_id,department_name,human_amount,salary_sum,salary_paid_sum,register,regist_time,checker,check_time,check_status)
		values('1222556666','软件开发',20,99.99,98.99,'张三',now(),'李四',now(),'待复核')
...
create table salary_grant_details ( 
	...
	demand_salaray_sum double(10,2) not null,		-- demand_salaray_sumy应发薪酬总额
	...
	select * from salary_grant_details
		...
		insert into  salary_grant_details(salary_standard_id,salary_standard_name,salary_grant_id,human_id,human_name,bouns_sum,sale_sum,deduct_sum,demand_salaray_sum,salary_standard_sum,salary_paid_sum)
		values('1222556666','JAVA高级工程师','15623254','5525151','王五',98.99,8.66,1.36,100.36,99.99,88.88)

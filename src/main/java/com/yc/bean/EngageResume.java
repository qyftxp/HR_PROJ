...
public class EngageResume implements Serializable {
	...
	public String toString() {
		return "Engage_resume [res_id=" + res_id + ", human_name=" + human_name
				+ ", engage_type=" + engage_type + ", human_address="
				+ human_address + ", human_postcode=" + human_postcode
				...
				+ human_major_name + ", human_telephone=" + human_telephone
				+ ", human_email=" + human_email + ", human_hobby="
				+ human_hobby + ", human_specility=" + human_specility
				+ ", human_sex=" + human_sex + ", human_party=" + human_party
				+ ", human_race=" + human_race + ", human_age=" + human_age
				+ ", human_educated_degree=" + human_educated_degree
				+ ", human_educated_major=" + human_educated_major
				+ ", human_college=" + human_college + ", human_idcard="
				+ human_idcard + ", demand_salary_standard="
				+ demand_salary_standard + ", human_history_records="
				+ human_history_records + ", remark=" + remark
				+ ", recomandation=" + recomandation + ", human_picture="
				+ human_picture + ", check_status=" + check_status
				+ ", register=" + register + ", regist_time=" + regist_time
				+ ", checker=" + checker + ", check_time=" + check_time
				+ ", interview_status=" + interview_status + ", total_points="
				+ total_points + ", test_amount=" + test_amount
				+ ", test_checker=" + test_checker + ", test_check_time="
				+ test_check_time + ", pass_register=" + pass_register
				+ ", pass_regist_time=" + pass_regist_time + ", pass_checker="
				+ pass_checker + ", pass_check_time=" + pass_check_time
